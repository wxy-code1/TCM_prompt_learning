...
class BartEncoder(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        self.RNN = nn.LSTM(input_size=1024, hidden_size=512, num_layers=2,
...
class BartDecoder(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        self.RNN = nn.LSTM(input_size=768, hidden_size=384, num_layers=2,
                           bidirectional=True, batch_first=True)
        if embed_tokens is not None:
            self.embed_tokens = embed_tokens
        else:
...
class BartModel(BartPretrainedModel):
    def __init__(self, config: BartConfig):
        ...
        self.lstm = nn.LSTM(input_size=768, hidden_size=384, num_layers=2,
                                bidirectional=True, batch_first=True)
    ...
    def forward(
        ...
        # outputs,_ = self.lstm(encoder_outputs[0])
